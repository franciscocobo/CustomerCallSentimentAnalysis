...
def lambda_handler(event, context):
    ...
    content = get_finalresult(bucket, transcription, sentimentData)
...
def get_finalresult(bucket, transcription, sentimentData):
    content = transcription + '\n' + "Sentiment: " + sentimentData
    s3_resources.Object('bucket', 'sentimentAnalysisResult.txt').put(Body=content)
    return content
